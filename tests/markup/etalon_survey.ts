...
registerMarkupTests([
  ...
  },
  {
    ...
    getElement: (el) => {
      return (<HTMLElement>(
        el?.querySelector(
          ".sv-header__cell.sv-header__cell--bottom.sv-header__cell--left"
        )
      )) as HTMLElement;
    },
