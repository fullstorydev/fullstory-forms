...
import { QuestionImagePickerModel, ImageItemValue, SurveyModel, ItemValue } from "@bateman001/form-core";
  ...
  protected renderElement(): React.JSX.Element {
    ...
    return (
      <fieldset
        ...
        ref={field => this.setControl(field)}
      >
...
export class SurveyQuestionImagePickerItem extends ReactSurveyElement {
  ...
  handleOnChange(event: any) {
    ...
    this.question.updateElementDataFromItem(event);
