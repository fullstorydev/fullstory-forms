...
import { QuestionTagboxModel, DropdownListModel, DropdownMultiSelectListModel } from "@bateman001/form-core";
...
export class SurveyQuestionTagbox extends SurveyQuestionDropdownBase<QuestionTagboxModel> {
  ...
  protected renderItem(key: string, item: any): React.JSX.Element {
    const renderedItem = <SurveyQuestionTagboxItem key={key} question={this.question} item={item} />;
    return renderedItem;
  }
