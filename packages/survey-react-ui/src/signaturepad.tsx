...
export class SurveyQuestionSignaturePad extends SurveyQuestionElementBase {
    ...
    protected renderElement(): React.JSX.Element {
        ...
        const dataElement = this.getDataElement("fs-signature");
        return (
            <div
            ...
            >
                ...
                <div {...dataElement} className={this.masked}>
            ...
            <div className={cssClasses.controls}>
                ...
                >
                    {this.question.cssClasses.clearButtonIconId ? (
                        <SvgIcon iconName={this.question.cssClasses.clearButtonIconId} size={"auto"}></SvgIcon>
                    ) : (
                        <span>✖</span>
                    )}
                </button>
