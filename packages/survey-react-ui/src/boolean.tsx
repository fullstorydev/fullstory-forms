...
import { QuestionBooleanModel, CssClassBuilder, Base } from "fullstory-form-core";
    ...
    return (
      <div {...this.question.elementData} className={cssClasses.root} onKeyDown={this.handleOnKeyDown}>
        <label className={itemClass} onClick={this.handleOnClick}>
          ...
          />
          <div
            className={cssClasses.sliderGhost}
            onClick={event => this.handleOnLabelClick(event, this.question.swapOrder)}
          >
