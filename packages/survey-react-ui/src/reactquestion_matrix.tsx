...
export class SurveyQuestionMatrix extends SurveyQuestionElementBase {
    ...
    protected renderElement(): React.JSX.Element {
        ...
        const dataElement = this.getDataElement("fs-matrix");
        return (
            <div className={cssClasses.tableWrapper} ref={root => this.setControl(root)}>
                <fieldset {...dataElement}>
...
export class SurveyQuestionMatrixRow extends ReactSurveyElement {
    ...
    protected renderElement(): React.JSX.Element {
        ...
        if (this.question.hasRows) {
            ...
            rowsTD = (
                <td style={style} className={this.row.rowTextClasses}>
    ...
    protected renderInput(inputId: string, isChecked: boolean): React.JSX.Element {
        return (
            <input
                ...
                aria-label={this.question.getCellAriaLabel(
                    this.row.locText.renderedHtml,
                    this.column.locText.renderedHtml
                )}
