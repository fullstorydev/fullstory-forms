...
export class SurveyQuestion extends SurveyElementBase<any, any> {
    ...
    public static renderQuestionBody(creator: ISurveyCreator, question: Question): React.JSX.Element | any {
    ...
    protected renderQuestionContent(): React.JSX.Element {
        ...
        return (
            <div className={css || undefined} style={contentStyle} role="presentation">
                {errorsTop}
                {questionRender}
                {comment}
                {errorsBottom}
...
export class SurveyQuestionAndErrorsCell extends SurveyQuestionAndErrorsWrapped {
    ...
    protected renderCellContent(): React.JSX.Element {
        return <div className={this.props.cell.cellQuestionWrapperClassName}>{this.renderQuestion()}</div>;
    }
    protected renderElement(): React.JSX.Element {
        ...
        const element = { "fs-matrix-row": cell.getTitle(), "fs-matrix-column": "" };

        const dataElement = this.createElementData(element, "fs-matrix-cell");
        return (
            <td
                {...dataElement}
                ref={this.cellRef}
