...
QUnit.test("parseDateTime with validation mm/dd/yyyy", function (assert) {
  ...
  assert.equal(maskInstance._getMaskedValue("02/29/2000"), "02/2d/2000");
  assert.equal(maskInstance._getMaskedValue("02/29/2001"), "02/2d/2001");
});
...
QUnit.test("DateTime mask mm/dd/yyyy HH:MM", function (assert) {
  ...
  assert.equal(
    maskInstance._getMaskedValue("10/24/2023 1"),
    "10/24/2023 1H:MM"
  );
  assert.equal(
    maskInstance._getMaskedValue("10/24/2023 9"),
    "10/24/2023 09:MM"
  );
  assert.equal(
    maskInstance._getMaskedValue("10/24/2023 13:46"),
    "10/24/2023 13:46"
  );
  ...
  assert.equal(
    maskInstance._getMaskedValue("10/24/2023 3:"),
    "10/24/2023 3:MM"
  );
  assert.equal(
    maskInstance._getMaskedValue("10/24/2023 13:46"),
...
QUnit.test(
  "_getMaskedValue matchWholeMask is false m/d/yyyy",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "m/d/yyyy";
...
QUnit.test(
  "_getMaskedValue matchWholeMask is false mm/dd/yyyy",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yyyy";
...
QUnit.test("getISO_8601Format getUnmaskedValue", function (assert) {
  ...
  assert.equal(
    maskInstance.getUnmaskedValue("24/07/1998 12:45"),
    "1998-07-24T12:45"
  );
...
QUnit.test(
  "dateTime processInput serial input: insert characters",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yyyy";
    let result = maskInstance.processInput({
      insertedChars: "1",
      selectionStart: 0,
      selectionEnd: 0,
      prevValue: "mm/dd/yyyy",
...
QUnit.test(
  "dateTime processInput serial input: insert characters v2",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yyyy";
...
QUnit.test(
  "dateTime processInput serial input: insert characters m/d/yyyy",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "m/d/yyyy";
    let result = maskInstance.processInput({
...
QUnit.test(
  "dateTime processInput: insert characters mm/dd/yyyy",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yyyy";
    let result = maskInstance.processInput({
...
QUnit.test(
  "dateTime processInput: insert characters m/d/yy",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "m/d/yy";
    let result = maskInstance.processInput({
...
QUnit.test(
  "dateTime processInput: delete characters by backspace",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yyyy";
    let result = maskInstance.processInput({
      prevValue: "04/05/2024",
      selectionStart: 9,
      selectionEnd: 10,
      insertedChars: null,
...
QUnit.test(
  "dateTime processInput: editing by delete characters by backspace",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yyyy";
    let result = maskInstance.processInput({
...
QUnit.test(
  "dateTime processInput: delete characters by backspace m/d/yyyy",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "m/d/yyyy";
    let result = maskInstance.processInput({
...
QUnit.test("dateTime processInput: copy/paste", function (assert) {
  ...
  result = maskInstance.processInput({
    ...
    selectionStart: 0,
    selectionEnd: 0,
    insertedChars: "10.28.1996",
    inputDirection: "backward",
  });
  assert.equal(
    result.value,
    "10/28/1996",
    "empty value & insert new value 10.28.1996"
  );
  assert.equal(
...
QUnit.test(
  "dateTime processInput: min & max for 12-hour time",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "hh:MM tt";
...
QUnit.test(
  "dateTime processInput: min & max for 12-hour time - h",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
...
QUnit.test(
  "dateTime processInput: min & max medium range mm/dd/yyyy",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yyyy";
    ...
    assert.equal(result.value, "0m/dd/yyyy", "type 0");
    assert.equal(result.caretPosition, 1, "type 0");
    ...
    assert.equal(result.value, "05/dd/yyyy", "type 5");
    assert.equal(result.caretPosition, 3, "type 5");
    ...
    assert.equal(result.value, "02/dd/yyyy", "try type 2");
    assert.equal(result.caretPosition, 3, "try type 2");
    ...
    result = maskInstance.processInput({
      ...
      selectionStart: 9,
      selectionEnd: 9,
      prevValue: "05/12/202y",
      inputDirection: "forward",
    });
    assert.equal(result.value, "05/12/2024", "type 4");
    assert.equal(result.caretPosition, 10, "type 4");
  }
);

QUnit.test(
  "dateTime processInput: min & max medium range mm/dd/yy",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    ...
    assert.equal(result.value, "0m/dd/yy", "type 0");
    assert.equal(result.caretPosition, 1, "type 0");
    ...
    assert.equal(result.value, "05/dd/yy", "type 5");
    assert.equal(result.caretPosition, 3, "type 5");
    ...
    assert.equal(result.value, "02/dd/yy", "try type 2");
    assert.equal(result.caretPosition, 3, "try type 2");
    ...
    assert.equal(result.value, "1m/dd/yy", "type 1");
    assert.equal(result.caretPosition, 1, "type 1");
    ...
    assert.equal(result.value, "12/dd/yy", "type 2");
    assert.equal(result.caretPosition, 3, "type 2");
...
QUnit.test(
  "dateTime processInput: min & max medium range leap year YYYY",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yyyy";
    maskInstance.min = "2023-11-13";
...
QUnit.test(
  "dateTime processInput: min & max medium range leap year YY",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yy";
    maskInstance.min = "2023-11-13";
...
QUnit.test("dateTime processInput: min & max small range", function (assert) {
  ...
  assert.equal(result.caretPosition, 4, "try type 3");
...
QUnit.test(
  "dateTime processInput: min & max 1 year range mm/dd/yyyy",
  function (assert) {
    const maskInstance = new InputMaskDateTime();
    maskInstance.pattern = "mm/dd/yyyy";
    ...
    assert.equal(result.value, "02/dd/yyyy", "type 0");
    assert.equal(result.caretPosition, 3, "type 0");
  }
);
