...
const config = {
  ...
  entry: {
    ...
    "default-light-panelless": path.resolve(
      __dirname,
      "./src/themes/default-light-panelless.ts"
    ),
    "default-dark-panelless": path.resolve(
      __dirname,
    ...
    "sharp-light-panelless": path.resolve(
      __dirname,
      "./src/themes/sharp-light-panelless.ts"
    ),
    "sharp-dark-panelless": path.resolve(
      __dirname,
      "./src/themes/sharp-dark-panelless.ts"
    ),
    "borderless-light": path.resolve(
      __dirname,
      "./src/themes/borderless-light.ts"
    ),
    "borderless-dark": path.resolve(
      __dirname,
      "./src/themes/borderless-dark.ts"
    ),
    "borderless-light-panelless": path.resolve(
      __dirname,
      "./src/themes/borderless-light-panelless.ts"
    ),
    "borderless-dark-panelless": path.resolve(
      __dirname,
    ...
    "flat-light-panelless": path.resolve(
      __dirname,
      "./src/themes/flat-light-panelless.ts"
    ),
    "flat-dark-panelless": path.resolve(
      __dirname,
    ...
    "plain-light-panelless": path.resolve(
      __dirname,
      "./src/themes/plain-light-panelless.ts"
    ),
    "plain-dark-panelless": path.resolve(
      __dirname,
      "./src/themes/plain-dark-panelless.ts"
    ),
    "doubleborder-light": path.resolve(
      __dirname,
      "./src/themes/doubleborder-light.ts"
    ),
    "doubleborder-dark": path.resolve(
      __dirname,
      "./src/themes/doubleborder-dark.ts"
    ),
    "doubleborder-light-panelles": path.resolve(
      __dirname,
      "./src/themes/doubleborder-light-panelless.ts"
    ),
    "doubleborder-dark-panelless": path.resolve(
      __dirname,
    ...
    "layered-light-panelless": path.resolve(
      __dirname,
      "./src/themes/layered-light-panelless.ts"
    ),
    "layered-dark-panelless": path.resolve(
      __dirname,
    ...
    "solid-light-panelless": path.resolve(
      __dirname,
      "./src/themes/solid-light-panelless.ts"
    ),
    "solid-dark-panelless": path.resolve(
      __dirname,
      "./src/themes/solid-dark-panelless.ts"
    ),
    "three-dimensional-light": path.resolve(
      __dirname,
      "./src/themes/threedimensional-light.ts"
    ),
    "three-dimensional-dark": path.resolve(
      __dirname,
      "./src/themes/threedimensional-dark.ts"
    ),
    "three-dimensional-light-panelless": path.resolve(
      __dirname,
      "./src/themes/threedimensional-light-panelless.ts"
    ),
    "three-dimensional-dark-panelless": path.resolve(
      __dirname,
    ...
    "contrast-light-panelless": path.resolve(
      __dirname,
      "./src/themes/contrast-light-panelless.ts"
    ),
    "contrast-dark-panelless": path.resolve(
      __dirname,
