...
import { QuestionRankingModel, SurveyModel, ItemValue } from "@bateman001/fullstory-form-core";
        ...
        <div className={this.question.rootClass} ref={root => this.setControl(root)}>
          <div className={this.question.getContainerClasses("from")} data-ranking="from-container">
            ...
            {this.question.renderedUnRankingChoices.length === 0 ? (
              <div className={this.question.cssClasses.containerPlaceholder}>
                {" "}
...
export class SurveyQuestionRankingItem extends ReactSurveyElement {
  ...
  protected renderElement(): React.JSX.Element {
    let itemContent = ReactElementFactory.Instance.createElement(this.question.itemComponent, {
      item: this.item,
        ...
        <div tabIndex={-1} style={{ outline: "none" }}>
          ...
          <div className={this.cssClasses.itemContent}>
            <div className={this.cssClasses.itemIconContainer}>
              <svg className={this.question.getIconHoverCss()}>
                <use xlinkHref={this.question.dragDropSvgIcon}></use>
              </svg>
              <svg className={this.question.getIconFocusCss()}>
