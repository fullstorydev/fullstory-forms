...
export class SurveyQuestionPanelDynamicRemoveButton extends SurveyQuestionPanelDynamicAction {
  ...
  protected renderElement(): React.JSX.Element {
    ...
    return (
      <button id={id} className={this.question.getPanelRemoveButtonCss()} onClick={this.handleClick} type="button">
        <span className={this.question.cssClasses.buttonRemoveText}>{btnText}</span>
        <span className={this.question.cssClasses.iconRemove}></span>
      </button>
    );
  }
}
