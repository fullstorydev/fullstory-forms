...
import { QuestionMatrixDropdownRenderedRow, QuestionMatrixDropdownModelBase } from "@bateman001/fullstory-form-core";
...
ReactElementFactory.Instance.registerElement("sv-matrix-row", (props: IMatrixRowProps) => {
