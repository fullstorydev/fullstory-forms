...
import { createTOCListModel, getTocRootCss, TOCModel } from "@bateman001/fullstory-form-core";
...
export class SurveyProgressToc extends SurveyNavigationBase {
  render(): React.JSX.Element {
    ...
    if (tocModel.isMobile) {
      content = (
        <div onClick={tocModel.togglePopup}>
    ...
    return <div className={tocModel.containerCss}>{content}</div>;
  }
}
